      ...
      phases: [
        {
          ...
          cycling: '2 × 45–60 min',
          weeks: [
            { num: 1, dates: 'May 8–14', longRun: { date: 'May 9', km: 9 }, runA: { date: 'May 12', km: 5 }, cutback: false },
            { num: 2, dates: 'May 15–21', longRun: { date: 'May 16', km: 10 }, runA: { date: 'May 19', km: 5 }, cutback: false },
            { num: 3, dates: 'May 22–28', longRun: { date: 'May 23', km: 11 }, runA: { date: 'May 26', km: 6 }, cutback: false },
            { num: 4, dates: 'May 29–Jun 4', longRun: { date: 'May 30', km: 8 }, runA: { date: 'Jun 2', km: 4 }, cutback: true },
          ],
        },
        {
          name: 'Phase 2 — Build',
          ...
          cycling: '2 × 60–90 min',
          weeks: [
            { num: 5, dates: 'Jun 5–11', longRun: { date: 'Jun 6', km: 13 }, runA: { date: 'Jun 9', km: 6 }, cutback: false },
            { num: 6, dates: 'Jun 12–18', longRun: { date: 'Jun 13', km: 14.5 }, runA: { date: 'Jun 16', km: 7 }, cutback: false },
            { num: 7, dates: 'Jun 19–25', longRun: { date: 'Jun 20', km: 16 }, runA: { date: 'Jun 23', km: 7 }, cutback: false },
            { num: 8, dates: 'Jun 26–Jul 2', longRun: { date: 'Jun 27', km: 12 }, runA: { date: 'Jun 30', km: 5 }, cutback: true },
          ],
        },
        {
          ...
          cycling: '2 × 45–75 min',
          weeks: [
            { num: 9, dates: 'Jul 3–9', longRun: { date: 'Jul 4', km: 17.5 }, runA: { date: 'Jul 7', km: 7 }, cutback: false },
            { num: 10, dates: 'Jul 10–16', longRun: { date: 'Jul 11', km: 19 }, runA: { date: 'Jul 14', km: 6 }, cutback: false },
            { num: 11, dates: 'Jul 17–23', longRun: { date: 'Jul 18', km: 21 }, runA: { date: 'Jul 21', km: 5 }, cutback: false },
            { num: 12, dates: 'Jul 24–30', longRun: { date: 'Jul 25', km: 10 }, runA: { date: 'Jul 28', km: 4 }, cutback: true, taper: true },
          ],
        },
      ],
      rules: [
