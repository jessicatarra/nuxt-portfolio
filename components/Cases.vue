          ...
          >
            <div class="flex flex-col justify-between pr-2 lg:pr-18 space-y-6">
              <h4
                class="text-3xl md:text-4xl font-inter font-bold leading-none"
              >
                Dados Legais Website
              </h4>
              <p class="leading-loose mr-4 text-lg">
                Datos legais is a platform that helps public and private
                institutions in compliance with the General Data Protection Law
                - LGPD.<br />
                Technologies: Vanilla Javascript, Sass and Grunt js.
              </p>
            </div>
            <div
              class="
            ...
            >
              <img
                class="website-img absolute rounded max-w-max block"
                src="../assets/images/dadoslegais-website.png"
                alt=""
              />
            </div>
          </a>
        ...
        <div class="overflow-hidden pt-16">
          ...
          >
            <div class="flex flex-col justify-between pr-2 lg:pr-18 space-y-6">
              ...
              <p class="leading-loose mr-4 text-lg">
                MISS2.0 is the first entirely digital competition organised for
                young Cotê d'Ivoire women.<br />
                Technologies: Wordpress and PHP.
              </p>
            </div>
            <div
              class="
            ...
            >
              <img
                class="website-img absolute rounded max-w-max block"
                src="../assets/images/miss-website.png"
                alt=""
              />
            </div>
          </a>
        ...
        <div class="overflow-hidden pt-16">
          ...
          >
            <div class="flex flex-col justify-between pr-2 lg:pr-18 space-y-6">
              ...
              <p class="leading-loose mr-4 text-lg">
                Founded in 1996, Gap Asset is a pioneer in the independent
                management market. <br />Technologies: Nextjs, Typescript, AWS
                and headless CMS (Strapi).
              </p>
            </div>
            <div
              class="
            ...
            >
              <img
                class="website-img absolute rounded max-w-max block"
                src="../assets/images/gapasset-website.png"
                alt=""
              />
            </div>
          </a>
