<template>
  <section id="blog" class="wrapper">
    <div class="md:pt-24 pt-18 pb-24">
      <div
        class="relative z-10 flex p-8 lg:p-16 rounded-md border bg-gradient-to-t from-blue-400 md:from-blue-500 to-purple-200"
      >
        <div class="flex flex-col justify-between pr-2 lg:pr-18 space-y-6">
          <h2
            class="text-3xl md:text-4xl text-white font-inter font-bold leading-none"
          >
            Blog
          </h2>
          <span
